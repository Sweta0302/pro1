...
void add_student()
{
    ...
    scanf("%s", st[i].fname);
    printf("Enter the Regd Number\n");
    scanf("%d", &st[i].regd_no);
 ...
 
{
    ...
    while (i = 1) {
        ...
        printf("2. Find the Student "
               "Details by Regd Number\n");
        printf("3. Find the Student "
               "Details by Full Name\n");
